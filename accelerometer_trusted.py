...
Drop_Fields_node1689411601636 = DropFields.apply(
    ...
    transformation_ctx="Drop_Fields_node1689411601636",
)

# Script generated for node accelerometer_trusted_zone
accelerometer_trusted_zone_node1689411827421 = (
    glueContext.write_dynamic_frame.from_options(
        frame=Drop_Fields_node1689411601636,
        connection_type="s3",
        format="json",
        connection_options={
            "path": "s3://tuanpa40-lake-house/accelerometer_trusted/",
            "partitionKeys": [],
        },
...
accelerometer_trusted_node1689418714817 = glueContext.write_dynamic_frame.from_catalog(
    frame=Drop_Fields_node1689411601636,
    database="tuanpa40",
    table_name="accelerometer_trusted",
    transformation_ctx="accelerometer_trusted_node1689418714817",
)
